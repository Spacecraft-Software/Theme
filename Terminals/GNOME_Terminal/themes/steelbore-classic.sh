...
#
# Steelbore Classic — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore Classic' GNOME Terminal profile via dconf.
#
...
PROFILE_NAME='Steelbore Classic'
...
dconf write "${PROFILE_PATH}palette" "['#000027', '#FF5C5C', '#50FA7B', '#D98E32', '#4B7EB0', '#4B7EB0', '#8BE9FD', '#D98E32', '#4B7EB0', '#FF5C5C', '#50FA7B', '#D98E32', '#4B7EB0', '#4B7EB0', '#8BE9FD', '#D98E32']"
