...
#
# Steelbore Magnetar High Contrast — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore Magnetar High Contrast' GNOME Terminal profile via dconf.
#
...
PROFILE_NAME='Steelbore Magnetar High Contrast'
...
dconf write "${PROFILE_PATH}background-color" "'#141418'"
...
dconf write "${PROFILE_PATH}cursor-foreground-color" "'#141418'"
dconf write "${PROFILE_PATH}highlight-colors-set" true
dconf write "${PROFILE_PATH}highlight-background-color" "'#F07BFF'"
dconf write "${PROFILE_PATH}highlight-foreground-color" "'#141418'"
dconf write "${PROFILE_PATH}palette" "['#141418', '#FF8F8F', '#5BE49B', '#FFC857', '#FC8AFF', '#F07BFF', '#FDBBFF', '#FFFFFF', '#FC8AFF', '#FF8F8F', '#5BE49B', '#FFC857', '#FC8AFF', '#F07BFF', '#FDBBFF', '#FFFFFF']"
