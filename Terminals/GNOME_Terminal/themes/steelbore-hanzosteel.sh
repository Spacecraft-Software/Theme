...
#
# Steelbore Hanzo Steel — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore Hanzo Steel' GNOME Terminal profile via dconf.
#
...
PROFILE_NAME='Steelbore Hanzo Steel'
...
dconf write "${PROFILE_PATH}palette" "['#000000', '#F04A44', '#5BE49B', '#F7D02A', '#F4B900', '#FCD612', '#FCD612', '#F5F0E6', '#F4B900', '#F04A44', '#5BE49B', '#F7D02A', '#F4B900', '#FCD612', '#FCD612', '#F5F0E6']"
