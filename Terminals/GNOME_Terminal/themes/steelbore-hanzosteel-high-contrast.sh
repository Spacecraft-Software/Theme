...
#
# Steelbore Hanzo Steel High Contrast — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore Hanzo Steel High Contrast' GNOME Terminal profile via dconf.
#
...
PROFILE_NAME='Steelbore Hanzo Steel High Contrast'
...
dconf write "${PROFILE_PATH}foreground-color" "'#F5F0E6'"
dconf write "${PROFILE_PATH}bold-color-same-as-fg" false
dconf write "${PROFILE_PATH}bold-color" "'#F5F0E6'"
dconf write "${PROFILE_PATH}bold-is-bright" true
dconf write "${PROFILE_PATH}cursor-colors-set" true
dconf write "${PROFILE_PATH}cursor-background-color" "'#F5F0E6'"
dconf write "${PROFILE_PATH}cursor-foreground-color" "'#000000'"
dconf write "${PROFILE_PATH}highlight-colors-set" true
dconf write "${PROFILE_PATH}highlight-background-color" "'#FCD612'"
dconf write "${PROFILE_PATH}highlight-foreground-color" "'#000000'"
dconf write "${PROFILE_PATH}palette" "['#000000', '#FF8F8F', '#5BE49B', '#F7D02A', '#F4B900', '#FCD612', '#FCD612', '#F5F0E6', '#F4B900', '#FF8F8F', '#5BE49B', '#F7D02A', '#F4B900', '#FCD612', '#FCD612', '#F5F0E6']"
