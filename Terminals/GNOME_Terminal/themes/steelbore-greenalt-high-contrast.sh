...
#
# Steelbore Green Alt High Contrast — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore Green Alt High Contrast' GNOME Terminal profile via dconf.
#
...
PROFILE_NAME='Steelbore Green Alt High Contrast'
...
dconf write "${PROFILE_PATH}background-color" "'#0D0208'"
dconf write "${PROFILE_PATH}foreground-color" "'#D7F5E0'"
dconf write "${PROFILE_PATH}bold-color-same-as-fg" false
dconf write "${PROFILE_PATH}bold-color" "'#D7F5E0'"
dconf write "${PROFILE_PATH}bold-is-bright" true
dconf write "${PROFILE_PATH}cursor-colors-set" true
dconf write "${PROFILE_PATH}cursor-background-color" "'#D7F5E0'"
dconf write "${PROFILE_PATH}cursor-foreground-color" "'#0D0208'"
dconf write "${PROFILE_PATH}highlight-colors-set" true
dconf write "${PROFILE_PATH}highlight-background-color" "'#00FF41'"
dconf write "${PROFILE_PATH}highlight-foreground-color" "'#0D0208'"
dconf write "${PROFILE_PATH}palette" "['#0D0208', '#FF6B6B', '#00B81C', '#FFC857', '#25B85F', '#00FF41', '#00FF41', '#D7F5E0', '#25B85F', '#FF6B6B', '#00B81C', '#FFC857', '#25B85F', '#00FF41', '#00FF41', '#D7F5E0']"
