...
#
# Steelbore Classic High Contrast — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore Classic High Contrast' GNOME Terminal profile via dconf.
#
...
PROFILE_NAME='Steelbore Classic High Contrast'
...
dconf write "${PROFILE_PATH}bold-color" "'#D98E32'"
dconf write "${PROFILE_PATH}bold-is-bright" true
dconf write "${PROFILE_PATH}cursor-colors-set" true
dconf write "${PROFILE_PATH}cursor-background-color" "'#D98E32'"
dconf write "${PROFILE_PATH}cursor-foreground-color" "'#000027'"
dconf write "${PROFILE_PATH}highlight-colors-set" true
dconf write "${PROFILE_PATH}highlight-background-color" "'#7FAEDC'"
dconf write "${PROFILE_PATH}highlight-foreground-color" "'#000027'"
dconf write "${PROFILE_PATH}palette" "['#000027', '#FF8080', '#50FA7B', '#D98E32', '#7FAEDC', '#7FAEDC', '#8BE9FD', '#D98E32', '#7FAEDC', '#FF8080', '#50FA7B', '#D98E32', '#7FAEDC', '#7FAEDC', '#8BE9FD', '#D98E32']"
