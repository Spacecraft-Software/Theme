...
#
# Steelbore NavyWhite — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore NavyWhite' GNOME Terminal profile via dconf.
#
...
PROFILE_NAME='Steelbore NavyWhite'
...
dconf write "${PROFILE_PATH}highlight-background-color" "'#2A5580'"
dconf write "${PROFILE_PATH}highlight-foreground-color" "'#E7E5E0'"
dconf write "${PROFILE_PATH}palette" "['#E7E5E0', '#93211F', '#2A6349', '#6F4E0C', '#1C2433', '#2A5580', '#2A5580', '#111827', '#1C2433', '#93211F', '#2A6349', '#6F4E0C', '#1C2433', '#2A5580', '#2A5580', '#111827']"
