...
#
# Steelbore High Contrast — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore High Contrast' GNOME Terminal profile via dconf.
#
...
PROFILE_NAME='Steelbore High Contrast'
...
dconf write "${PROFILE_PATH}foreground-color" "'#D9DEE5'"
dconf write "${PROFILE_PATH}bold-color-same-as-fg" false
dconf write "${PROFILE_PATH}bold-color" "'#D9DEE5'"
dconf write "${PROFILE_PATH}bold-is-bright" true
dconf write "${PROFILE_PATH}cursor-colors-set" true
dconf write "${PROFILE_PATH}cursor-background-color" "'#D9DEE5'"
dconf write "${PROFILE_PATH}cursor-foreground-color" "'#000027'"
dconf write "${PROFILE_PATH}highlight-colors-set" true
dconf write "${PROFILE_PATH}highlight-background-color" "'#FF8A3D'"
dconf write "${PROFILE_PATH}highlight-foreground-color" "'#000027'"
dconf write "${PROFILE_PATH}palette" "['#000027', '#FF7A7A', '#B4FF00', '#EE7BFF', '#B3A1FF', '#FF8A3D', '#B4FF00', '#D9DEE5', '#B3A1FF', '#FF7A7A', '#B4FF00', '#EE7BFF', '#B3A1FF', '#FF8A3D', '#B4FF00', '#D9DEE5']"
