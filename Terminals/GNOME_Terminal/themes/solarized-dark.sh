...
#
# Solarized Dark — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Solarized Dark' GNOME Terminal profile via dconf.
#
...
dconf write "${PROFILE_PATH}foreground-color" "'#839496'"
dconf write "${PROFILE_PATH}bold-color-same-as-fg" false
dconf write "${PROFILE_PATH}bold-color" "'#839496'"
dconf write "${PROFILE_PATH}bold-is-bright" true
dconf write "${PROFILE_PATH}cursor-colors-set" true
dconf write "${PROFILE_PATH}cursor-background-color" "'#839496'"
dconf write "${PROFILE_PATH}cursor-foreground-color" "'#002B36'"
dconf write "${PROFILE_PATH}highlight-colors-set" true
dconf write "${PROFILE_PATH}highlight-background-color" "'#268BD2'"
dconf write "${PROFILE_PATH}highlight-foreground-color" "'#002B36'"
dconf write "${PROFILE_PATH}palette" "['#002B36', '#DC322F', '#859900', '#B58900', '#6C71C4', '#268BD2', '#2AA198', '#839496', '#6C71C4', '#DC322F', '#859900', '#B58900', '#6C71C4', '#268BD2', '#2AA198', '#839496']"
