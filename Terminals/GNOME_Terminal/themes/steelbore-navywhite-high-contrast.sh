...
#
# Steelbore NavyWhite High Contrast — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore NavyWhite High Contrast' GNOME Terminal profile via dconf.
#
...
PROFILE_NAME='Steelbore NavyWhite High Contrast'
...
dconf write "${PROFILE_PATH}background-color" "'#E7E5E0'"
dconf write "${PROFILE_PATH}foreground-color" "'#111827'"
dconf write "${PROFILE_PATH}bold-color-same-as-fg" false
dconf write "${PROFILE_PATH}bold-color" "'#111827'"
dconf write "${PROFILE_PATH}bold-is-bright" true
dconf write "${PROFILE_PATH}cursor-colors-set" true
dconf write "${PROFILE_PATH}cursor-background-color" "'#111827'"
dconf write "${PROFILE_PATH}cursor-foreground-color" "'#E7E5E0'"
dconf write "${PROFILE_PATH}highlight-colors-set" true
dconf write "${PROFILE_PATH}highlight-background-color" "'#1F4A73'"
dconf write "${PROFILE_PATH}highlight-foreground-color" "'#E7E5E0'"
dconf write "${PROFILE_PATH}palette" "['#E7E5E0', '#7E1C1A', '#16452F', '#5A3F09', '#1C2433', '#1F4A73', '#1F4A73', '#111827', '#1C2433', '#7E1C1A', '#16452F', '#5A3F09', '#1C2433', '#1F4A73', '#1F4A73', '#111827']"
