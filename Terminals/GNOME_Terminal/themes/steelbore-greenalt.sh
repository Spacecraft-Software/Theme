...
#
# Steelbore Green Alt — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore Green Alt' GNOME Terminal profile via dconf.
#
...
PROFILE_NAME='Steelbore Green Alt'
...
dconf write "${PROFILE_PATH}palette" "['#0D0208', '#FF6B6B', '#00AD15', '#FFC857', '#1CA152', '#00FF41', '#00FF41', '#D7F5E0', '#1CA152', '#FF6B6B', '#00AD15', '#FFC857', '#1CA152', '#00FF41', '#00FF41', '#D7F5E0']"
