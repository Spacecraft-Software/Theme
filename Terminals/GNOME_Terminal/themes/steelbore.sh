...
#
# Steelbore — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore' GNOME Terminal profile via dconf.
#
...
dconf write "${PROFILE_PATH}highlight-background-color" "'#FF5E00'"
dconf write "${PROFILE_PATH}highlight-foreground-color" "'#000027'"
dconf write "${PROFILE_PATH}palette" "['#000027', '#FF3B3B', '#B4FF00', '#E445FF', '#8A6CFF', '#FF5E00', '#B4FF00', '#D9DEE5', '#8A6CFF', '#FF3B3B', '#B4FF00', '#E445FF', '#8A6CFF', '#FF5E00', '#B4FF00', '#D9DEE5']"
