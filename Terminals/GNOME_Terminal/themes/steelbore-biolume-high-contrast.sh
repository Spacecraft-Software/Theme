...
#
# Steelbore Biolume High Contrast — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore Biolume High Contrast' GNOME Terminal profile via dconf.
#
...
PROFILE_NAME='Steelbore Biolume High Contrast'
...
dconf write "${PROFILE_PATH}background-color" "'#0C1A2B'"
dconf write "${PROFILE_PATH}foreground-color" "'#C7D2D9'"
dconf write "${PROFILE_PATH}bold-color-same-as-fg" false
dconf write "${PROFILE_PATH}bold-color" "'#C7D2D9'"
dconf write "${PROFILE_PATH}bold-is-bright" true
dconf write "${PROFILE_PATH}cursor-colors-set" true
dconf write "${PROFILE_PATH}cursor-background-color" "'#C7D2D9'"
dconf write "${PROFILE_PATH}cursor-foreground-color" "'#0C1A2B'"
dconf write "${PROFILE_PATH}highlight-colors-set" true
dconf write "${PROFILE_PATH}highlight-background-color" "'#B6FF3B'"
dconf write "${PROFILE_PATH}highlight-foreground-color" "'#0C1A2B'"
dconf write "${PROFILE_PATH}palette" "['#0C1A2B', '#FF8F8F', '#2FD3BB', '#FFC857', '#00F0FF', '#B6FF3B', '#B6FF3B', '#C7D2D9', '#00F0FF', '#FF8F8F', '#2FD3BB', '#FFC857', '#00F0FF', '#B6FF3B', '#B6FF3B', '#C7D2D9']"
