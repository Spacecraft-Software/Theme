...
#
# Steelbore Magnetar — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore Magnetar' GNOME Terminal profile via dconf.
#
...
PROFILE_NAME='Steelbore Magnetar'
...
dconf write "${PROFILE_PATH}highlight-background-color" "'#E445FF'"
dconf write "${PROFILE_PATH}highlight-foreground-color" "'#141418'"
dconf write "${PROFILE_PATH}palette" "['#141418', '#FF6B6B', '#5BE49B', '#FFC857', '#FC8AFF', '#E445FF', '#FDBBFF', '#FFFFFF', '#FC8AFF', '#FF6B6B', '#5BE49B', '#FFC857', '#FC8AFF', '#E445FF', '#FDBBFF', '#FFFFFF']"
