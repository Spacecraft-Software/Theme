...
#
# Tokyo Night — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Tokyo Night' GNOME Terminal profile via dconf.
#
...
dconf write "${PROFILE_PATH}highlight-background-color" "'#7AA2F7'"
dconf write "${PROFILE_PATH}highlight-foreground-color" "'#1A1B26'"
dconf write "${PROFILE_PATH}palette" "['#1A1B26', '#F7768E', '#9ECE6A', '#E0AF68', '#BB9AF7', '#7AA2F7', '#7DCFFF', '#C0CAF5', '#BB9AF7', '#F7768E', '#9ECE6A', '#E0AF68', '#BB9AF7', '#7AA2F7', '#7DCFFF', '#C0CAF5']"
