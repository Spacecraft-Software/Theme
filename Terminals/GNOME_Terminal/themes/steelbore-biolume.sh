...
#
# Steelbore Biolume — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore Biolume' GNOME Terminal profile via dconf.
#
...
PROFILE_NAME='Steelbore Biolume'
...
dconf write "${PROFILE_PATH}palette" "['#0C1A2B', '#FF6B6B', '#00B39A', '#FFC857', '#00F0FF', '#B6FF3B', '#B6FF3B', '#C7D2D9', '#00F0FF', '#FF6B6B', '#00B39A', '#FFC857', '#00F0FF', '#B6FF3B', '#B6FF3B', '#C7D2D9']"
