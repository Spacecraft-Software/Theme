...
#
# Steelbore BlackPinkPanther — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore BlackPinkPanther' GNOME Terminal profile via dconf.
#
...
PROFILE_NAME='Steelbore BlackPinkPanther'
...
dconf write "${PROFILE_PATH}highlight-background-color" "'#F400A1'"
dconf write "${PROFILE_PATH}highlight-foreground-color" "'#000000'"
dconf write "${PROFILE_PATH}palette" "['#000000', '#FF6B6B', '#5BE49B', '#FFC857', '#FF46AA', '#F400A1', '#F400A1', '#FFFFFF', '#FF46AA', '#FF6B6B', '#5BE49B', '#FFC857', '#FF46AA', '#F400A1', '#F400A1', '#FFFFFF']"
