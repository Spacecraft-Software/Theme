...
#
# Tokyo Night High Contrast — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Tokyo Night High Contrast' GNOME Terminal profile via dconf.
#
...
PROFILE_NAME='Tokyo Night High Contrast'
...
dconf write "${PROFILE_PATH}bold-color" "'#C0CAF5'"
...
dconf write "${PROFILE_PATH}highlight-background-color" "'#97B6F9'"
dconf write "${PROFILE_PATH}highlight-foreground-color" "'#1A1B26'"
dconf write "${PROFILE_PATH}palette" "['#1A1B26', '#F998AA', '#9ECE6A', '#E0AF68', '#BB9AF7', '#97B6F9', '#7DCFFF', '#C0CAF5', '#BB9AF7', '#F998AA', '#9ECE6A', '#E0AF68', '#BB9AF7', '#97B6F9', '#7DCFFF', '#C0CAF5']"
