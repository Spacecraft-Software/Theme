...
#
# Steelbore Blue — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore Blue' GNOME Terminal profile via dconf.
#
...
dconf write "${PROFILE_PATH}highlight-background-color" "'#3390FF'"
dconf write "${PROFILE_PATH}highlight-foreground-color" "'#0A1024'"
dconf write "${PROFILE_PATH}palette" "['#0A1024', '#FF6B6B', '#28C76F', '#FFC857', '#3390FF', '#3390FF', '#FF8A4B', '#E6F0FF', '#3390FF', '#FF6B6B', '#28C76F', '#FFC857', '#3390FF', '#3390FF', '#FF8A4B', '#E6F0FF']"
