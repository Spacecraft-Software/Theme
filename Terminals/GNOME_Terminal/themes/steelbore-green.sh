...
#
# Steelbore Green — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Steelbore Green' GNOME Terminal profile via dconf.
#
...
dconf write "${PROFILE_PATH}palette" "['#0D0208', '#FF6B6B', '#00AD15', '#FFC857', '#1CA152', '#E8FFF0', '#E8FFF0', '#00FF41', '#1CA152', '#FF6B6B', '#00AD15', '#FFC857', '#1CA152', '#E8FFF0', '#E8FFF0', '#00FF41']"
