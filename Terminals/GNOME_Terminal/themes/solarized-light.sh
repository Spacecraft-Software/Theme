...
#
# Solarized Light — GNOME Terminal theme (dconf profile installer)
...
# Creates the 'Solarized Light' GNOME Terminal profile via dconf.
#
...
dconf write "${PROFILE_PATH}foreground-color" "'#657B83'"
dconf write "${PROFILE_PATH}bold-color-same-as-fg" false
dconf write "${PROFILE_PATH}bold-color" "'#657B83'"
dconf write "${PROFILE_PATH}bold-is-bright" true
dconf write "${PROFILE_PATH}cursor-colors-set" true
dconf write "${PROFILE_PATH}cursor-background-color" "'#657B83'"
dconf write "${PROFILE_PATH}cursor-foreground-color" "'#FDF6E3'"
dconf write "${PROFILE_PATH}highlight-colors-set" true
dconf write "${PROFILE_PATH}highlight-background-color" "'#268BD2'"
dconf write "${PROFILE_PATH}highlight-foreground-color" "'#FDF6E3'"
dconf write "${PROFILE_PATH}palette" "['#FDF6E3', '#DC322F', '#859900', '#B58900', '#6C71C4', '#268BD2', '#2AA198', '#657B83', '#6C71C4', '#DC322F', '#859900', '#B58900', '#6C71C4', '#268BD2', '#2AA198', '#657B83']"
