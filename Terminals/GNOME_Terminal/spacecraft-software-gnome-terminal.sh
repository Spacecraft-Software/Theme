# Spacecraft Software Theme for GNOME Terminal
# Version: 1.0
# Author: Mohamed Hammad
# License: GPL3+
# URL: https://SpacecraftSoftware.org
#
# Installation: Run this script in your terminal.
# It creates a new GNOME Terminal profile named "Spacecraft Software".

#!/usr/bin/env bash

PROFILE_NAME="Spacecraft Software"
PROFILE_SLUG="spacecraft-software"
...
echo "Spacecraft Software profile created for GNOME Terminal!"
echo "Go to Terminal → Preferences → Profiles → select 'Spacecraft Software'."
