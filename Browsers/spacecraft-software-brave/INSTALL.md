# Installing Spacecraft Software Theme for Brave Browser
...
`themes/<slug>/manifest.json`. Brave is Chromium-based and installs exactly
...
3. Drag and drop `themes/spacecraft-software-brave-<slug>.zip` onto the page.

## Notes

- This theme changes only the visual appearance of the browser chrome; it
  does not touch Brave's privacy or Shields settings.
