...
5. Select the `spacecraft-software-chrome/` folder.
...
3. Drag and drop the `spacecraft-software-chrome-theme.zip` file onto the page.

## Method 3: Chrome Web Store

1. Package the theme as a `.crx` file using Chrome's extension tools.
